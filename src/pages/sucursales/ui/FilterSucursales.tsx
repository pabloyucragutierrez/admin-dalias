...
import type { FilterOptionsSucursales } from "@/interfaces/sucursales.interface";

interface FilterSucursalesProps {
  onApplyFilters: (filters: FilterOptionsSucursales) => void;
  onClearFilters: () => void;
  initialFilters?: FilterOptionsSucursales;
  loading: boolean;
}

const FilterSucursales: React.FC<FilterSucursalesProps> = ({
  onApplyFilters,
  onClearFilters,
  initialFilters = {},
  loading,
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const nonEmptyFilters: FilterOptionsSucursales = {};
    Object.entries(filters).forEach(([key, value]) => {
      if (value && value.trim() !== "") {
        nonEmptyFilters[key as keyof FilterOptionsSucursales] = value.trim();
      }
    });
