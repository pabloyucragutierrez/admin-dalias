...
import type { FilterOptions } from "@/interfaces/empresas.interface";

interface FilterEmpresasProps {
...
const FilterEmpresas: React.FC<FilterEmpresasProps> = ({
  onApplyFilters,
  onClearFilters,
  initialFilters = {},
  loading,
        ...
        {Object.entries(filters).map(([key, value]) =>
          value ? (
            ...
            >
              ...
              {key === "ruc" && <span className="mr-1">RUC: </span>}
